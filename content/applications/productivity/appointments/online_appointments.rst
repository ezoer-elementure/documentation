...
- :guilabel:`Appointment Title`
- :guilabel:`Duration`: Define the duration of the reservation/booking/slot/appointment.
- :guilabel:`Scheduling` and **Cancelling** rules:
  ...
  - **Maximum Scheduling Window**: Appointments cannot be scheduled more than **xx days** in
    advance.
  - :guilabel:`Max in xx days or from *Date*`
  - **Cancellation Policy**: :guilabel:`Allow Cancellation` up to **xx hours** before the appointment.
- :guilabel:`Availability`
  ...
  - :guilabel:`Resources`: Booking corresponds to reserving available resources (e.g., restaurant
    tables, tennis courts, event rooms).

    - Define the bookable resources.
...
Use the **Calendar** view to get an overview of all booked appointments and manage them efficiently.
